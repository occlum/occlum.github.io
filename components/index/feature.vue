<template>
  <div id="feature" class="container">
    <div class="inner">
      <h1 class="title right">Features</h1>
      <div class="list-content">
        <div class="line">
          <div class="item">
            <img src="~/assets/image/multitasking.png" alt="" class="icon">
            <div class="right">
              <h2 class="sub-title">Efficient Multitasking</h2>
          ...
          <div class="item">
            ...
            <div class="right">
              <h2 class="sub-title">Multiple File System Support</h2>
        ...
        <div class="line">
          <div class="item">
            ...
            <div class="right">
              <h2 class="sub-title">Memory Safe</h2>
          ...
          <div class="item">
            ...
            <div class="right">
              <h2 class="sub-title">Ease-of-use</h2>
